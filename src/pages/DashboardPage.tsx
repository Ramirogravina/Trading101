...
export const DashboardPage = ({ holdings }: { holdings: Holding[] }) => {
  ...
  return <section className="page"><h1>Home</h1>
    <div className="stats-grid">
      <article className="card"><p>Total invertido</p><h2>${totalInvested.toFixed(2)}</h2></article>
      <article className="card"><p>Valor actual</p><h2>${totalValue.toFixed(2)}</h2></article>
